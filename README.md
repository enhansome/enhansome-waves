...
* [Go Node](https://github.com/wavesplatform/gowaves) ⭐ 251 | 🐛 26 | 🌐 Go | 📅 2026-09-09 - Go libraries and tools for Waves blockchain, alternative implementation of Node (work in progress).
...
* [chaincmp](https://github.com/wavesplatform/gowaves/blob/master/cmd/chaincmp) ⭐ 251 | 🐛 26 | 🌐 Go | 📅 2026-09-09 - Utility to compare blockchains on a different nodes.
...
* [Ride for Pygments](https://github.com/pygments/pygments/blob/master/pygments/lexers/ride.py) ⭐ 2,206 | 🐛 657 | 🌐 Python | 📅 2026-08-17 - The [Pygments](https://github.com/pygments/pygments) ⭐ 2,206 | 🐛 657 | 🌐 Python | 📅 2026-08-17 highlighter oficially supports the Ride out of the box.
