...
* [Ride introduction](https://github.com/wavesplatform/ride-introduction) ⭐ 19 | 🐛 1 | 📅 2019-12-13 - Shortest and simplest explanation of Ride.\
...
* [Node](https://github.com/wavesplatform/Waves) ⭐ 1,168 | 🐛 18 | 🌐 Scala | 📅 2026-08-27 - Waves Node repository on GitHub.
* [Go Node](https://github.com/wavesplatform/gowaves) ⭐ 251 | 🐛 28 | 🌐 Go | 📅 2026-08-27 - Go libraries and tools for Waves blockchain, alternative implementation of Node (work in progress).
...
* [WavesCS](https://github.com/wavesplatform/WavesCS) ⚠️ Archived - C# library to interact with the Waves blockchain.
...
* [go-lib-crypto](https://github.com/wavesplatform/go-lib-crypto) ⭐ 5 | 🐛 1 | 🌐 Go | 📅 2020-08-31 - GoLang implementation of the unified crypto primitives for Waves.

#### PHP

* [WavesKit](https://github.com/deemru/WavesKit) ⭐ 24 | 🐛 0 | 🌐 PHP | 📅 2026-03-29 - All-in-one Waves Platform development kit for the PHP language.

#### Python

* [Waves-Gateway-Framework](https://github.com/jansenmarc/WavesGatewayFramework) ⭐ 24 | 🐛 8 | 🌐 Python | 📅 2023-03-01 - A framework to connect other cryptocurrencies to the Waves blockchain ([LTC example](https://github.com/jansenmarc/WavesGatewayLTCExample) ⭐ 7 | 🐛 2 | 🌐 Python | 📅 2018-04-21).
* [ERC20 Gateway Framework](https://github.com/PyWaves/Waves-ERC20-Gateway) ⭐ 8 | 🐛 0 | 🌐 Python | 📅 2019-12-31 - Allows to easily establish a gateway between any ERC-20 token and the Waves blockchain ([example](https://github.com/iammortimer/TN-WAVES-Gateway) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2020-04-03).
* [PyWaves](https://github.com/PyWaves/PyWaves) ⭐ 0 | 🐛 33 | 🌐 Python | 📅 2026-02-05 - Object-oriented library for the Waves blockchain platform.

#### Rust

* [waves-lib-rust](https://github.com/waves-rust/waves-lib-rust) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2023-08-29 - Library to work with Waves blockchain.
* [WavesRS](https://github.com/petermz/WavesRs) ⭐ 0 | 🐛 0 | 🌐 Rust | 📅 2018-09-26 - A Rust interface for the Waves blockchain.
...
* [chaincmp](https://github.com/wavesplatform/gowaves/blob/master/cmd/chaincmp) ⭐ 251 | 🐛 28 | 🌐 Go | 📅 2026-08-27 - Utility to compare blockchains on a different nodes.
...
* [Ride for Pygments](https://github.com/pygments/pygments/blob/master/pygments/lexers/ride.py) ⭐ 2,205 | 🐛 637 | 🌐 Python | 📅 2026-08-17 - The [Pygments](https://github.com/pygments/pygments) ⭐ 2,205 | 🐛 637 | 🌐 Python | 📅 2026-08-17 highlighter oficially supports the Ride out of the box.
