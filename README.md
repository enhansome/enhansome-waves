...
* [Go Node](https://github.com/wavesplatform/gowaves) ⭐ 251 | 🐛 29 | 🌐 Go | 📅 2026-08-14 - Go libraries and tools for Waves blockchain, alternative implementation of Node (work in progress).
...
* [chaincmp](https://github.com/wavesplatform/gowaves/blob/master/cmd/chaincmp) ⭐ 251 | 🐛 29 | 🌐 Go | 📅 2026-08-14 - Utility to compare blockchains on a different nodes.
...
* [Ride for Pygments](https://github.com/pygments/pygments/blob/master/pygments/lexers/ride.py) ⭐ 2,199 | 🐛 603 | 🌐 Python | 📅 2026-07-28 - The [Pygments](https://github.com/pygments/pygments) ⭐ 2,199 | 🐛 603 | 🌐 Python | 📅 2026-07-28 highlighter oficially supports the Ride out of the box.
