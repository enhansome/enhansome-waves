...
* [Node](https://github.com/wavesplatform/Waves) ⭐ 1,168 | 🐛 24 | 🌐 Scala | 📅 2026-09-02 - Waves Node repository on GitHub.
* [Go Node](https://github.com/wavesplatform/gowaves) ⭐ 251 | 🐛 28 | 🌐 Go | 📅 2026-09-02 - Go libraries and tools for Waves blockchain, alternative implementation of Node (work in progress).
...
* [chaincmp](https://github.com/wavesplatform/gowaves/blob/master/cmd/chaincmp) ⭐ 251 | 🐛 28 | 🌐 Go | 📅 2026-09-02 - Utility to compare blockchains on a different nodes.
...
* [Ride for Pygments](https://github.com/pygments/pygments/blob/master/pygments/lexers/ride.py) ⭐ 2,206 | 🐛 639 | 🌐 Python | 📅 2026-08-17 - The [Pygments](https://github.com/pygments/pygments) ⭐ 2,206 | 🐛 639 | 🌐 Python | 📅 2026-08-17 highlighter oficially supports the Ride out of the box.
